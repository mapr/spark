...
PKG_VERSION=${PKG_VERSION:-"3.5.5.500"} # For packaging
...
MVN_PROFILE_ARG=${MVN_PROFILE_ARG:-"-Pyarn,hadoop-provided,hadoop-3.4,scala-2.12,hive,hive-thriftserver,sparkr,kubernetes,include-kafka,include-kafka-sql,include-maprdb"}
