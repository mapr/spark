...
if __name__ == "__main__":
    ...
    os.environ["PYSPARK_SUBMIT_ARGS"] = "--conf \"spark.driver.extraJavaOptions=-Dzookeeper.sasl.serverconfig=Server_simple -Dzookeeper.sasl.clientconfig=Client_simple -Dzookeeper.saslprovider=com.mapr.security.simplesasl.SimpleSaslProvider\" --jars %s pyspark-shell" % jars
