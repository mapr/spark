...
public class MapRDBJavaContext {
    ...
    public static <K> PairedRDDJavaFunctions<K> maprDBSparkContext(JavaPairRDD<K,
            OJAIDocument> rdd, Class<K> keyClazz) {

        return new PairedRDDJavaFunctions<>(rdd, keyClazz);
    }

    public static <K, V> PairedRDDBeanJavaFunctions<K, V> maprDBSparkContext(
            JavaPairRDD<K, V> rdd, Class<K> keyClazz, Class<V> valueClazz) {
